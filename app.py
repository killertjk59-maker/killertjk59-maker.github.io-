...
# ============ ТАНЗИМОТ ============
PRICE_PER_KG = 23  # Нархи 1 кг: 23 сомонӣ
...
<div class="container">
  ...
  <div class="card" id="calc">
    ...
    <p style="color:#666;margin-bottom:15px">Нархи 1 кг — <strong style="color:#1e3c72">23 сомонӣ</strong></p>
    <div class="calc-grid">
      <div>
        <label>Вазн (кг)</label>
...
Тел: +992 71 555 50 00</div>
  ...
  <div class="card" id="faq">
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">23 сомонӣ барои 1 кг. Барои борҳои калон тахфиф пешбинӣ шудааст. Калкулятори моро истифода баред.</div>
    </div>
  </div>
...
function calculate(){
  ...
  if(w > 0){
    document.getElementById('calcDetail').textContent = `${w} кг × ${q} баста × 23 сомонӣ`;
  } else {
  ...
  <div class="dashboard-layout">
    ...
    <div class="profile-card">
      ...
      <div class="profile-details">
        ...
        <p><strong>Нархи умумӣ:</strong> 23 сомонӣ/кг</p>
    ...
    <div class="stats">
      ...
      <div class="stat-card stat-card-gold"><div class="num">{{projected_revenue}} сомонӣ</div><div class="lbl">Даромади умумӣ (23с/кг)</div></div>
